...
jQuery.noConflict(),jQuery(document).ready(function(a){a("#wtt-keyword").keypress(function(a){13==a.which&&a.preventDefault()}),a(".dropdown-toggle").dropdown(),a(".btn-info-d").popover()});